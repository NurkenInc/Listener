...
const errorInputClassName =
    "w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-red-500 outline-none focus:border-red-300";
                ...
                <div className='bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden max-w-[1000px]'>
                    <div className='md:flex w-full'>
                        <div className='flex items-center justify-center w-full bg-[#22333e]'>
                            <img src='/signupFormBg.png' alt='signup form' />
                        </div>
                            ...
                            <div>
                                <div className='flex -mx-3'>
                                    <div className='w-full px-3 mb-5'>
                                        ...
                                        {!emailValid ? (
                                            <p className='ml-2 text-red-500 italic'>
                                    ...
                                    <div className='w-full px-3 mb-5'>
                                        ...
                                        {!formDataValid ? (
                                            <div>
                                                <p className='ml-2 text-red-500 italic'>
                                                    <b>
                                                        Some form input's are
                                                        empty
                                                    </b>
                                                </p>
                                                <p className='ml-2 text-gray-400 italic'>
                                                    Please fill this input's and
                                                    click submit
                                                </p>
                                            </div>
                                        ) : error ? (
