...
export default function CustomSidebar(props: any) {
    ...
    const [editNoteNameModalToggler, setEditNoteNameModalToggler] =
        useState(false);
    ...
    const { toggleSidebar, collapseSidebar, broken, collapsed } =
        useProSidebar();

    const [theme, setTheme] = React.useState<Theme>("light");

    function toggleEditNoteNameModal() {
        setEditNoteNameModalToggler(
            (editNoteNameModalToggler) => !editNoteNameModalToggler
        );
    }
    ...
    async function handleUpdateCardTitle(
        deckId: string,
        cardNewName: string,
        index: number
    ) {
                            ...
                            <Menu menuItemStyles={menuItemStyles}>
                                <MenuItem
                                    ...
                                    onClick={() => {
                                        ...
                                        editNoteNameModalToggler !== true
                                            ? setEditNoteNameModalToggler(true)
                                            : {};
                                    }}
                                    suffix={
                                        editNoteNameModalToggler === true &&
                                        selectedItemId === "createFolder" ? (
                                            ...
                                            selectedItemId === deck._id ? (
                                                ...
                                                <div className='flex flex-row'>
                                                    <button
                                                        ...
                                                        className='add-note px-[8px] py-[3px]'
                                                        onClick={() => {
                                                            history(
                                                                `/listener/decks/${deck._id}/cards`
                                                            );
                                                        }}
                                                    >
                                                        <FontAwesomeIcon
                                        ...
                                        {deck.cards.map((card, index) => (
                                            <MenuItem
                                                onClick={() => {
                                                    ...
                                                    history(
                                                        `/listener/decks/${deck._id}/cards/${index}`,
                                                        {
                                                            state: {
                                                                cardData:
                                                                    decks.find(
